...
@SupportedAnnotationTypes("com.jackmeng.compiler._Emits") public final class jmcc_Emits
    extends AbstractProcessor
{
  @Override public boolean process(Set< ? extends TypeElement > annotations, RoundEnvironment roundEnv)
  {
    for (Element element : roundEnv.getElementsAnnotatedWith(_Debug.class))
    {
      ...
      String warnMessage = "System.out.println(\"" + method.getAnnotation(_Debug.class).message() + ");";
